...
export function normalizeEventosPage(payload) {
  ...
  return {
    ...
    totais: {
      horas: totais.horas ?? 0,
      horasPlan: totais.horasPlanejadas ?? totais.horasPlan ?? 0,
      horasPres: totais.horasPresentes ?? totais.horasPres ?? 0,
      horasAuse: totais.horasAusentes ?? totais.horasAuse ?? 0,
    },
  };
}
...
export function normalizeGrupoDto(dto) {
  return {
    ...
    horasPlan: Number(dto.horasPlanejadas ?? dto.horasPlan) || 0,
  };
}
