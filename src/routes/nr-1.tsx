...
import { Nr1Card } from "../panels/posicao/Nr1Card.jsx";
import { resolveEmpresaLabel } from "../panels/posicao/saudePreventivaCampanhas.js";
import { readNr1OpenContext } from "../panels/posicao/nr1Open.js";
import "../panels/posicao/posicao-bento.css";

export const Route = createFileRoute("/nr-1")({
  head: () => ({
    meta: [
      { title: "NR-1 — GRO / PGR / Riscos Psicossociais" },
      {
        name: "description",
        content: "Gestão de conformidade com a NR-1 — GRO, PGR e riscos psicossociais (Portaria MTE 1.419/2024).",
      },
    ],
  }),
  component: Nr1Page,
