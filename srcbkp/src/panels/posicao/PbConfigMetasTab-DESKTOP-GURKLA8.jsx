      ...
      <div className="pb-cfg-field">
        ...
        <div className="pb-cfg-meta-row">
          <input
            ...
            onChange={(e) => canEditMetas && onAbsMetaChange(e.target.value)}
            onBlur={canEditMetas ? onAbsMetaBlur : undefined}
      ...
      <div className="pb-cfg-field">
        ...
        <div className="pb-cfg-meta-row">
          <input
            ...
            value={turnoverMeta}
            disabled={!canEditMetas}
            onChange={(e) => canEditMetas && onTurnoverMetaChange(e.target.value)}
            onBlur={canEditMetas ? onTurnoverMetaBlur : undefined}
