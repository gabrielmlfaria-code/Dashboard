...
test("buildPosListModalData usa data do colaborador da API", () => {
  ...
  assert.equal(data.events[0].data, "2026-05-19");
});
...
test("buildPosListModalData ferias inclui data inicio e fim", () => {
  ...
  assert.equal(data.events[0].inicio, "2026-05-01");
  assert.equal(data.events[0].termino, "2026-05-15");
});
...
test("buildPosListModalData ferias hidrata inicio e fim pelo historico importado", () => {
  ...
  assert.equal(data.events.length, 1);
  assert.equal(data.events[0].inicio, "2026-05-01");
  assert.equal(data.events[0].termino, "2026-05-20");
});
